...
public class UploadProgressRequestBody extends RequestBody {
    ...
    protected ProgressResonseCallBack progressCallBack;

    protected CountingSink countingSink;

    public UploadProgressRequestBody(ProgressResonseCallBack listener) {
        this.progressCallBack = listener;
    }

    public UploadProgressRequestBody(RequestBody delegate, ProgressResonseCallBack progressCallBack) {
